...
Available backbones:
  ...
  Text:  MobileCLIP-S0, MobileCLIP-S1, MobileCLIP2-L
    ...
    if not export_image and not export_text:
        print("No export option specified. Use --export-image-encoder, --export-text-encoder, or --export-all")
        return
    ...
    print(f"  1. Run optimize_onnx_for_npu.py to replace GELU/LayerNorm")
    print(f"  2. Use your NPU compiler to compile the ONNX model")
